...
export type LogSummary = { id: string; workspaceId: string; authorId: string; authorName: string; day: string; title: string | null; body: string; createdAt: string; updatedAt: string; tags: string[]; mirrorDirty: boolean; posX: number | null; posY: number | null; width: number | null; height: number | null };
